...
import { FLimit, FLimitInMemory } from "../../src/index.js";
...
describe("Regression", function () {
	describe("0.0.3", function () {
		it("The timers in the limit instance should not blocks process exit", async function () {
			const limit: FLimit = new FLimitInMemory({
				perSecond: 2,
				perMinute: 4,
				perHour: 50,
				parallel: 2
	...
	describe("0.0.4", function () {
		...
		it("dispose() should block flow while use any tokens", async function () {
			...
			let limitToken1: FLimit.Token;
			let limitToken2: FLimit.Token;
			let limitToken3: FLimit.Token;
			try {
